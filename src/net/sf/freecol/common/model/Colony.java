...
public class Colony extends Settlement implements Nameable, TradeLocation {
    ...
    /** A map of BreedingData, indexed by the ids of GoodsTypes. */
    protected final java.util.Map<String, BreedingData> breedingData = new HashMap<>();
    ...
    /** Whether to make a new colonist when the food reaches 200 in the colony. */
    protected Boolean makesNewColonists = null;
    ...
    /**
     * Gets whether this colony has breeding data for a goods type.
     *
     * @param goodsType The <code>GoodsType</code> to check.
     * @return True if this colony has breeding data for the goods type.
     */
    public boolean haveBreedingData(final GoodsType goodsType) {
        BreedingData result = breedingData.get(goodsType.getId());
        return (result != null);
    }

    /**
     * Get the breeding data for a goods type.
     *
     * @param goodsType The <code>GoodsType</code> to check.
     * @return The required <code>BreedingData</code>.
     */
    public BreedingData getBreedingData(final GoodsType goodsType) {
        BreedingData result = breedingData.get(goodsType.getId());
        if (result == null) {
            result = new BreedingData(goodsType,
                getSpecification().getBoolean(GameOptions.DEFAULT_BREEDING_ONLY_SURPLUS),
                getSpecification().getInteger(GameOptions.DEFAULT_BREEDING_CONSUME_RATIO));
            setBreedingData(result);
        }
        return result;
    }

    /**
     * Set some breeding data.
     *
     * @param newBreedingData A new <code>BreedingData</code> value.
     */
    public final void setBreedingData(final BreedingData newBreedingData) {
        breedingData.put(newBreedingData.getId(), newBreedingData);
    }
    ...
    /**
     * Gets the makesNewColonists of the colony.
     *
     * @return The current makesNewColonists of the colony.
     */
    public Boolean getMakesNewColonists() {
        return makesNewColonists;
    }

    /**
     * Sets the makesNewColonists of the colony.
     *
     * @param newMakesNewColonists A new <code>makesNewColonists</code> value.
     */
    public void setMakesNewColonists(Boolean newMakesNewColonists) {
        makesNewColonists = newMakesNewColonists;
    }
    ...
    private static final String MAKES_NEW_COLONISTS_TAG = "makesNewColonists";
    ...
    protected void writeAttributes(FreeColXMLWriter xw) throws XMLStreamException {
        ...
        if (makesNewColonists != null) xw.writeAttribute(MAKES_NEW_COLONISTS_TAG, makesNewColonists);
    }
    ...
    protected void writeChildren(FreeColXMLWriter xw) throws XMLStreamException {
        ...
        if (xw.validFor(getOwner())) {
            ...
            for (Entry<String, BreedingData> e : mapEntriesByKey(breedingData)) {
                e.getValue().toXML(xw);
            }
    ...
    public void readAttributes(FreeColXMLReader xr) throws XMLStreamException {
        ...
        if (xr.getAttribute(MAKES_NEW_COLONISTS_TAG, "") == "") makesNewColonists = null;
        else makesNewColonists = xr.getAttribute(MAKES_NEW_COLONISTS_TAG, true);
    }
    ...
    public void readChild(FreeColXMLReader xr) throws XMLStreamException {
        ...
        } else if (BreedingData.TAG.equals(tag)) {
            BreedingData data = new BreedingData(xr);
            breedingData.put(data.getId(), data);
