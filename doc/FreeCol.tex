...
\item The checkbox \Option{Quick Trade} enables Ships and Wagon Trains
  to do not use up their moves left when trading or arriving to a
  colony or (un)loading cargo.
